...
function Login() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-8 font-sans text-sm antialiased text-white transition-colors ease-out bg-gray-900 sm:text-base">
      {isLoading ? (
        ...
        <div className="z-20 grid w-full max-w-5xl grid-cols-3 gap-4 md:gap-8">
          <div className="flex items-end justify-between col-span-3">
            <a
          ...
          <div className="flex flex-col col-span-3 p-4 space-y-6 rounded-md sm:space-y-4">
            <div className="flex items-center justify-between">
              <h4 className="text-2xl font-medium">Get Started</h4>
            </div>
            <p>
              Login to your auth server to access the private pages. Make sure
              your Auth Server and API projects are also running.
            </p>
            <button
              onClick={(e) => {
                e.preventDefault();
          ...
          >
            ...
            <h5 className="mt-4 text-xl font-semibold">Documentation</h5>
            <p className="mt-2">
              Find in depth information about the Wrapt framework.
            </p>
          </a>
          <a
            href="https://github.com/pdevito3/craftsman"
          ...
          >
            ...
            <h5 className="text-xl font-semibold">Discord</h5>
            <p>
              Join the Wrapt Discord to participate in community discussions and
              get latest news about releases.
            </p>
          </a>
        </div>
      )}
