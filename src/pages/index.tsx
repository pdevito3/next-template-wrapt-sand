...
export default function Home() {
  ...
  return (
    <>
      ...
      <PrivateLayout>
        <div className="flex flex-col items-start justify-start min-h-screen p-8 font-sans text-sm antialiased text-white transition-colors ease-out bg-gray-900 sm:text-base">
          <div className="z-20 grid w-full max-w-5xl grid-cols-3 gap-4 md:gap-8">
            ...
            <div className="flex flex-col col-span-3 p-4 space-y-6 rounded-md sm:space-y-4">
              <div className="flex items-center justify-between">
                <h4 className="text-2xl font-medium">Welcome!</h4>
              </div>
              <p>
            ...
            >
              ...
              <p>
                Join the Wrapt Discord to participate in community discussions
                and get latest news about releases.
              </p>
            </a>
          </div>
        </div>
